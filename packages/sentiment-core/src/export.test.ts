...
const appJsPath = path.join(import.meta.dirname, "../../../apps/web/public/app.v8.js");
...
test("generateReportMarkdown - structure", () => {
  const data = {
    ...
    negative: 3,
    mixed: 0,
    topPositive: [{ author: "user1", sentiment: "POSITIVE", confidence: 90, text: "great vid" }],
    timeSeries: [{ date: "2026-06-12", pos: 5, neg: 3 }],
  };
