...
var require_scoring_strategy = __commonJS({
  "node_modules/sentiment/languages/en/scoring-strategy.js"(exports, module) {
    ...
    module.exports = {
      apply: /* @__PURE__ */ __name(function(tokens, cursor, tokenScore) {
        if (cursor > 0) {
...
var require_language_processor = __commonJS({
  "node_modules/sentiment/lib/language-processor.js"(exports, module) {
    ...
    module.exports = {
       ...
       */
      addLanguage: /* @__PURE__ */ __name(function(languageCode, language) {
        if (!language.labels) {
       ...
       */
      getLanguage: /* @__PURE__ */ __name(function(languageCode) {
        if (!languageCode) {
          return languages.en;
        }
       ...
       * @return {Object}
       */
      getLabels: /* @__PURE__ */ __name(function(languageCode) {
       ...
       */
      applyScoringStrategy: /* @__PURE__ */ __name(function(languageCode, tokens, cursor, tokenScore) {
        var language = this.getLanguage(languageCode);
...
var require_lib = __commonJS({
  "node_modules/sentiment/lib/index.js"(exports, module) {
    ...
    var Sentiment2 = /* @__PURE__ */ __name(function(options) {
...
// src/shared-sentiment.ts
var import_sentiment = __toESM(require_lib(), 1);

// node_modules/emoji-emotion/index.js
var emojiEmotion = [
  {
    name: "100",
    emoji: "\u{1F4AF}",
...
var toxicLexicon = /* @__PURE__ */ new Set([
  "anjing",
  "babi",
  "bangsat",
  "kontol",
...
__name(analyzeEdgeSafe, "analyzeEdgeSafe");

// src/worker.ts
function getShingles(text, k = 2) {
...
__name(getShingles, "getShingles");
  ...
  async fetch(request, env, ctx) {
    ...
    if (url.pathname === "/api/analyze-video" && request.method === "POST") {
      try {
        ...
        const buzzerRingsMap = /* @__PURE__ */ new Map();
        ...
        for (const c of allComments) {
          ...
          if (cShingles.size > 0 && !res.isSpam) {
            ...
            if (recentShingles.length > 1e3) recentShingles.shift();
          }
          if (c.publishedAt) {
        ...
        const buzzerRings = Array.from(buzzerRingsMap.entries()).map(([id, data]) => ({ id, count: data.count, text: data.text })).sort((a, b) => b.count - a.count).slice(0, 5);
        const timeSeries = Array.from(timeSeriesMap.entries()).map(([date, data]) => ({ date, pos: data.pos, neg: data.neg })).sort((a, b) => a.date.localeCompare(b.date));
        ...
        return new Response(JSON.stringify({
          ...
          // returned for export capabilities
        }), {
          headers: { "Content-Type": "application/json", ...corsHeaders }
        });
      } catch (err) {
